...
import { Accordion,AccordionButton,AccordionItem,AccordionPanel,Box,Thead,Th,Tr
,Table,Tbody,Alert,Text,Stack,Spinner,AlertIcon,AlertDescription,AlertTitle,Wrap,useToast } from '@chakra-ui/react'
...
<Box>
    <Text mr='8px' fontWeight='bold'>Add new product</Text>
</Box>
            </Box>
        </AccordionButton>
    </h2>
    ...
    <Tbody>
        {
            products.length >0 && products.map((product)=>{
                return <ProductTableItem key={product._id} product={product}/>
            })
        }
    </Tbody>
</Table>
